...
![Navigate 웹 앱 시작 상태 캡처](/assets/img/navigate-web-startup.png)
...
![Navigate 웹 배포 설정 요약 캡처](/assets/img/navigate-web-build-config.png)
...
![Navigate 로그인 화면 캡처](/assets/img/navigate-web-login.png)
...
![Navigate 설정 화면 캡처](/assets/img/navigate-web-settings.png)
